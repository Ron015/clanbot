...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      //setup-autosupport
      client.autosupport.ensure(message.guild.id, {
        messageId: "",
        channelId: "",
        data: [
          /*
      ...
      async function handle_the_picks(optionhandletype, menuoptiondata) {
        switch (optionhandletype) {
          case "Send the Config	Message": {
            let data = client.autosupport.get(message.guild.id, "data");
            let settings = client.autosupport.get(message.guild.id);
            ...
            if (collected && collected.first().content) {
              ...
              if (collected2 && collected2.first().mentions.channels.size > 0) {
                ...
                channel.send({
                  ...
                  client.autosupport.set(message.guild.id, msg.id, "messageId");
                  client.autosupport.set(message.guild.id, channel.id, "channelId");
              ...
              if (button?.user.id === cmduser.id) {
                ...
                if(button?.customId != "yes"){
                  ...
                  if (collected3 && collected3.first().content) {
                    ...
                    client.autosupport.push(message.guild.id, {
                      value,
                      description,
                      sendEmbed,
                      replyMsg
                ...
                collector.on('collect', async button => {
                  if (button?.user.id === cmduser.id) {
                    ...
                    if (collected3 && collected3.first().content) {
                      ...
                      client.autosupport.set(message.guild.id, data, "data");
