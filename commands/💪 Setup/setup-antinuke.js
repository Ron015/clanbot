            ...
            async function menuselection2(menu) {
              ...
              if(String(index) == "0"){
                ...
                let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                  ...
                  .setColor(es.color)
                  .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable19"])).setFooter(es.footertext, es.footericon)
                ]})
                ...
                let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                  ...
                  .setColor(es.color)
                  .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable25"])).setFooter(es.footertext, es.footericon)
                ]})
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                    max: 1,
                    time: 90000,
                ...
                let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                  ...
                  .setColor(es.color)
                  .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable31"])).setFooter(es.footertext, es.footericon)
                ]})
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                    max: 1,
                    time: 90000,
                ...
                let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                  ...
                  .setColor(es.color)
                  .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable37"])).setFooter(es.footertext, es.footericon)
                ]})
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                    max: 1,
                    time: 90000,
                ...
                let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                  ...
                  .setColor(es.color)
                  .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable43"])).setFooter(es.footertext, es.footericon)
                ]})
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                    max: 1,
                    time: 90000,
                ...
                let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                  ...
                  .setColor(es.color)
                  .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable49"])).setFooter(es.footertext, es.footericon)
                ]})
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                    max: 1,
                    time: 90000,
                ...
                let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                  ...
                  .setColor(es.color)
                  .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable55"])).setFooter(es.footertext, es.footericon)
                ]})
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                    max: 1,
                    time: 90000,
              ...
              async function menuselection3(menu) {
                ...
                if(String(index) == "0"){
                  ...
                  let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                    ...
                    .setColor(es.color)
                    .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable68"])).setFooter(es.footertext, es.footericon)
                  ]})
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                      max: 1,
                      time: 90000,
                  ...
                  let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                    ...
                    .setColor(es.color)
                    .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-antinuke"]["variable77"])).setFooter(es.footertext, es.footericon)
                  ]})
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                      max: 1,
                      time: 90000,
