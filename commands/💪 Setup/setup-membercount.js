    ...
    try {
      ...
      async function second_layer(SetupNumber, menuoptiondata){
        ...
        var tempmsg = await message.reply ({embeds: [new Discord.MessageEmbed()
          .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable6"]))
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable7"])).setFooter(es.footertext, es.footericon)]
          })
          ...
          .then(async collected => {
            ...
            if(channel){
              ...
              message.reply({embeds: [new Discord.MessageEmbed()
                .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable8"]))
                .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              ...
              tempmsg = await message.reply({embeds: [new Discord.MessageEmbed()
                .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable9"]))
                .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                ...
                .then(async collected => {
                  ...
                  if(name && name.length <= 32){
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable10"]))
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
...
> **Optimal Member-Count Channels:** \`6 or less\``.substr(0, 2048))
                ...
                .catch(e => {
                  ...
                  return message.reply({embeds: [new Discord.MessageEmbed()
                    .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable11"]))
          ...
          .catch(e => {
            ...
            return message.reply({embeds: [new Discord.MessageEmbed()
              .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable12"]))
              .setColor(es.wrongcolor)
              .setDescription(`Cancelled the Operation!`.substr(0, 2000))
              .setFooter(es.footertext, es.footericon)
            ]});
      ...
      return message.reply({embeds: [new MessageEmbed()
        ...
        .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-membercount copy"]["variable15"]))
